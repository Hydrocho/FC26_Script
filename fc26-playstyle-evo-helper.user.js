...
(function () {
  ...
  const PS_DESC = {
    "Finesse Shot": "감아 차는 슛의 속도와 커브, 정확도가 향상됩니다.",
    "Chip Shot": "칩슛과 로빙슛이 더 정확하고 빠르게, 더 가파르게 떨어집니다.",
    "Power Shot": "파워슛 준비 동작이 빨라지고, 더 낮고 강하게 날아갑니다.",
    "Dead Ball": "직접 프리킥에 조준 보정, 추가 커브, 파워가 적용됩니다.",
    "Precision Header": "헤딩 슛, 패스, 클리어링의 속도와 정확도가 향상됩니다.",
    "Acrobatic": "발리슛과 아크로바틱 마무리가 더 빠르고 안정적으로 나갑니다.",
    "Low Driven Shot": "낮게 깔리는 강한 슛이 되어 골키퍼가 막기 어려워집니다.",
    "Gamechanger": "박스 밖 슛의 속도와 정확도가 향상됩니다.",
    "Incisive Pass": "수비 사이를 가르는 스루패스가 더 빠르고 정확해집니다.",
    "Pinged Pass": "강하게 땅볼로 주는 패스가 더 빠르고 정확해집니다.",
    "Long Ball Pass": "긴 패스와 로빙 패스가 먼 거리에서도 더 빠르고 정확해집니다.",
    "Tiki Taka": "짧은 땅볼 패스가 더 빠르고 정교해지며 원터치 패스가 좋아집니다.",
    "Whipped Pass": "크로스의 속도, 커브, 정확도가 향상됩니다.",
    "Inventive": "스쿱 패스, 노룩 패스 등 플레어 패스가 더 안정적으로 연결됩니다.",
    "Jockey": "상대를 따라붙는 조키 수비가 더 빠르고 민첩해집니다.",
    "Block": "슛과 패스를 더 넓은 범위에서 효과적으로 차단합니다.",
    "Intercept": "패스를 읽고 끊어내는 범위와 성공률이 향상됩니다.",
    "Anticipate": "발밑에서 공을 따내는 스탠딩 태클이 더 깔끔하고 안전해집니다.",
    "Slide Tackle": "더 먼 거리에서 더 정확하게 슬라이딩 태클합니다.",
    "Aerial Fortress": "점프, 도달 거리, 타이밍이 좋아져 공중 경합을 더 많이 이깁니다.",
    "Technical": "근접 볼 컨트롤과 드리블 터치가 더 빠르고 정교해집니다.",
    "Rapid": "공을 몰며 전력 질주할 때 더 빠르게 가속합니다.",
    "First Touch": "트래핑 실수가 줄어들어 공을 더 가깝게 컨트롤합니다.",
    "Trickster": "공을 더 잘 지키며 개인기를 더 빠르게 사용합니다.",
    "Press Proven": "압박을 받아도 공을 덜 빼앗기고 버티는 능력이 향상됩니다.",
    "Quick Step": "공이 없을 때 폭발적으로 가속해 공간으로 빠르게 침투합니다.",
    "Relentless": "스태미나 소모가 줄고 하프타임 회복량이 늘어납니다.",
    "Long Throw": "스로인이 훨씬 더 멀리, 박스 안까지 도달합니다.",
    "Bruiser": "강한 어깨 경합으로 신체 싸움에서 더 많이 승리합니다.",
    "Enforcer": "경합에서 더 강해지고 태클 뒤 회복 속도가 빨라집니다.",
    "Far Throw": "골키퍼의 스로인이 더 멀리, 더 빠르게 날아가 역습을 시작합니다.",
    "Footwork": "골키퍼의 발놀림과 반사 신경을 활용한 선방이 더 빨라집니다.",
    "Cross Claimer": "페널티 박스를 장악하고 크로스를 더 안정적으로 잡아냅니다.",
    "1v1 Close Down": "더 빠르게 뛰어나가 일대일 상황을 막아냅니다(러시 아웃).",
    "Far Reach": "다이빙 도달 거리가 늘어나 구석으로 향하는 슛을 더 잘 막습니다.",
    "Deflector": "더 강한 손끝 쳐내기로 슛을 안전한 곳으로 막아냅니다.",
  };
